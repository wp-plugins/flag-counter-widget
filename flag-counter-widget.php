...
class Flag_Counter_Widget extends WP_Widget {
	...
	function Flag_Counter_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'flagcounter', 'description' => 'Display an Javascript based Flag Counter. If you like this Plugin please rate it at https://wordpress.org/plugins/flag-counter-widget/. Thank you.' );
